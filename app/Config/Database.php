...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Las claves con puntos (database.sqlserver.*) fallan en Windows con putenv().
        // Se usan claves SQLSRV_* sin puntos, que sí funcionan en todos los SO.
        ...
        $this->sqlserver['port']     = (int) env('SQLSRV_PORT',     $this->sqlserver['port']);
        $this->sqlserver['DBDebug']  = (ENVIRONMENT !== 'production');
    }
}
