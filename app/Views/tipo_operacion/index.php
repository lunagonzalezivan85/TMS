...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Gestiona los tipos de operación del sistema</p>
                </div>
                <div>
                    <a href="<?= base_url('tipo-operacion/create') ?>" class="btn btn-primary">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-table"></i> Lista de Tipos de Operación
            </h6>
        </div>
        <div class="card-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function inicializarTabla() {
        ...
        tabla = $('#tabla-tipos').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?= base_url('tipo-operacion/getData') ?>',
                type: 'POST',
                data: function(d) {
    ...
    function cargarEstadisticas() {
        fetch('<?= base_url('tipo-operacion/getEstadisticas') ?>', {
            method: 'GET',
            headers: {
    ...
    function setupEventListeners() {
        ...
        if (btnConfirmarEliminar) {
            btnConfirmarEliminar.addEventListener('click', function() {
                if (tipoIdEliminar) {
                    fetch(`<?= base_url('tipo-operacion/delete') ?>/${tipoIdEliminar}`, {
                        method: 'DELETE',
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        }
    ...
    // Event delegation para botones dinámicos (fuera de setupEventListeners para evitar duplicados)
