...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .reporte-container { max-width: 100%; margin: 0; }
            a { text-decoration: none !important; color: #000 !important; }
        }
        .linea-firma { border-bottom: 1px solid #000; width: 80%; display: inline-block; margin-bottom: 0.5rem; }
    </style>
</head>
<body>
    <div class="reporte-container">
        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
            <h4 class="fw-bold mb-0"><i class="fas fa-file-alt me-2 text-success"></i><?= esc($title) ?></h4>
            <div>
    ...
    <script>
        // Abrir automáticamente el diálogo de impresión si la página se abrió desde otra página
        if (window.opener) {
            // ya se abrió como popup, opcionalmente no hacer nada
        }
    </script>
</body>
</html>
