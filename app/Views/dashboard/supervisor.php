...
<div class="container-fluid py-4">
    <div class="dash-prompt">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="mb-0">Gestiona solicitudes, asigna técnicos y supervisa el flujo de mantenimiento. Usa <span class="kbd-hint"><i class="fas fa-command"></i> Ctrl K</span>.</p>
            </div>
    ...
    <div class="row g-4">
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3"><i class="fas fa-tasks me-2 text-primary"></i>Acciones rápidas</h6>
                    <div class="d-grid gap-2">
                        <a href="<?= base_url('solicitudes/create') ?>" class="btn btn-outline-primary rounded-pill text-start"><i class="fas fa-plus-circle me-2"></i>Nueva solicitud</a>
                        <a href="<?= base_url('solicitudes') ?>" class="btn btn-outline-warning rounded-pill text-start"><i class="fas fa-user-cog me-2"></i>Asignar técnicos</a>
                        <a href="<?= base_url('vehiculos') ?>" class="btn btn-outline-secondary rounded-pill text-start"><i class="fas fa-car me-2"></i>Revisar vehículos</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3"><i class="fas fa-chart-bar me-2 text-primary"></i>Resumen del día</h6>
                    <div class="d-flex justify-content-between mb-2"><span>Solicitudes totales</span><span class="fw-bold"><?= $stats['total_maintenance'] ?></span></div>
                    <div class="d-flex justify-content-between mb-2"><span>Por asignar</span><span class="fw-bold"><?= $stats['pending_maintenance'] ?></span></div>
                    <div class="d-flex justify-content-between"><span>Vehículos en taller</span><span class="fw-bold"><?= $stats['vehicles_maintenance'] ?></span></div>
                </div>
            </div>
        </div>
    </div>
