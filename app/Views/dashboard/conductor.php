    ...
    <div class="dash-prompt">
        <div class="row align-items-end">
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <p class="mb-0">¿Necesitas reportar una falla o revisar tu vehículo?</p>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0"><i class="fas fa-car-side me-2 text-primary"></i>Mi resumen</h5>
                <span class="text-muted small"><?= date('d/m/Y') ?></span>
            </div>
            <div class="row g-3">
                <div class="col-6 col-md-4">
                    <div class="summary-stat">
                        <span class="number text-primary"><?= $stats['total_maintenance'] ?></span>
                        <span class="label">Mis solicitudes</span>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="summary-stat">
            ...
            <div class="mt-4 d-flex flex-wrap gap-2">
                <a href="<?= base_url('solicitudes/create') ?>" class="btn btn-danger rounded-pill"><i class="fas fa-plus-circle me-2"></i>Reportar falla</a>
